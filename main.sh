...
shNpmInstall() {
  ...
  darwin)
    ...
    then
      ## download phantomjs
      SCRIPT=":"
      SCRIPT="$SCRIPT && curl -fLSs -C - -o $TMPDIR/phantomjs-1.9.7-macosx.zip"
    ...
    then
      ## download slimerjs
      SCRIPT=":"
      SCRIPT="$SCRIPT && curl -fLSs -C - -o $TMPDIR/slimerjs-0.9.3-mac.tar.bz2"
  ...
  linux)
    ...
    then
      ## download phantomjs
      SCRIPT=":"
      SCRIPT="$SCRIPT && curl -fLSs -C - -o $TMPDIR/phantomjs-1.9.7-linux-x86_64.tar.bz2"
    ...
    then
      ## download slimerjs
      SCRIPT=":"
      SCRIPT="$SCRIPT && curl -fLSs -C - -o $TMPDIR/slimerjs-0.9.3-linux-x86_64.tar.bz2"
